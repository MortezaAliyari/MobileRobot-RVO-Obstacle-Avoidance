...
//    log_publisher.publish(logdata);
    ROS_INFO("c: %d, rvoc: %d, theta:%f, Besttheta: %f, error : %f , uw: %f",counter,rvocounter,agent1pose2d.theta,besttheta,e,uw);
